...
const preparationTimeValue = document.querySelector("#preparationTimeValue");
const preparationTimeRange = document.querySelector("#preparationTime");
const cookingTimeValue = document.querySelector("#cookingTimeValue");
const cookingTimeRange = document.querySelector("#cookingTime");
...
function renderAside() {
    ...
    let selectedIngredients = selectIngredients.options[selectIngredients.selectedIndex];
    let selectedIngredientsValue = selectIngredients.value;
    renderMain(preparationTimeRangeValueNumber, cookingTimeRangeValueNumber, inputNameValue, selectedIngredientsValue);
}
function renderMain(preparationTimeRangeValueNumber, cookingTimeRangeValueNumber, inputNameValue, selectedIngredientsValue) {
    recipesList.forEach((recipe) => {
        let prepTimeNumber = parseInt(recipe.prepTime);
        let cookTimeNumber = parseInt(recipe.cookTime);
        if (prepTimeNumber <= preparationTimeRangeValueNumber &&
